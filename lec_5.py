...
def draw_house(x, y, width, height):
    """
    Функция рисует домик ролной ширины width и высоты height от опорной точки (x, y),
    которая находится в нижней точки фундамента.
    :param x: координата x середины домика
    :param y: координата y низа фкндамента
    :param width: полная ширина домика (фундамента или вылета крыши включены)
    :param height: полеая высота от низа фундамента
    :return: None
    """
...
def draw_house_foundation(x, y, width, height):
    """
    Функция основание домика ролной ширины width и высоты height от опорной точки (x, y),
    которая находится в нижней точки фундамента.
    :param x: координата x середины фундамента
    :param y: координата y низа фкндамента
    :param width: полная ширина фундамента
    :param height: полеая высота фундамента
    :return: None
    """
